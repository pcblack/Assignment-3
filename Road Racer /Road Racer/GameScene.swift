...
//            if touchLocation.x > centerPoint {
    ...
    @objc func traffic() {
        if !stopEverything {
            ...
            case 1...8:
                trafficItem = SKSpriteNode(imageNamed: "car_\(randomNumber)")
            ...
            trafficItem.zRotation = CGFloat(Double.pi)
    ...
    func afterCollision() {
        ...
        DispatchQueue.main.asyncAfter(deadline: .now() + 9.0) { // Change `2.0` to the desired number of seconds.
           // Code you want to be delayed
            ...
            self.view?.presentScene(menuScene, transition: SKTransition.doorsCloseHorizontal(withDuration: TimeInterval(1.5)))
        }
